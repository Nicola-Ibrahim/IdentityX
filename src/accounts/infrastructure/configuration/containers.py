...
from accounts.infrastructure.crypto.password_hasher import PBKDF2PasswordHasher
...
class AccountsContainer(containers.DeclarativeContainer):
    ...
    audit_service = providers.Factory(AuditService, audit_repo=audit_repository)
    ...
    social_providers = providers.Singleton(SocialProviders, providers=providers.Dict({"google": google_provider}))
