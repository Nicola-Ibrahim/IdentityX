...
from src.building_blocks.application.mediator.messages.commands import BaseCommand
from src.building_blocks.application.mediator.messages.queries import BaseQuery
from src.building_blocks.application.mediator.core.scanner import discover_command_handlers
