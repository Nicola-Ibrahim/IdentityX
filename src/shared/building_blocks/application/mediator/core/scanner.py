...
def discover_command_handlers() -> dict[type, type]:
    ...
    _scan_packages()
    from src.shared.building_blocks.application.mediator.messages.commands import (
        BaseCommandHandler,
    )
    from src.shared.building_blocks.application.mediator.messages.queries import (
        BaseQueryHandler,
    )
